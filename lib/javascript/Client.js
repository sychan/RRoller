...
function RRoller(url, auth, auth_cb, timeout, async_job_check_time_ms, service_version) {
    var self = this;
    ...
    var _auth_cb = auth_cb;
     ...
     this.rick_roll = function (roll_id, _callback, _errorCallback) {
        if (typeof roll_id === 'function')
            throw 'Argument roll_id can not be a function';
        ...
        return json_call_ajax(_url, "RRoller.rick_roll",
            [roll_id], 1, _callback, _errorCallback);
    };
    ...
    this.status = function (_callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "RRoller.status",
